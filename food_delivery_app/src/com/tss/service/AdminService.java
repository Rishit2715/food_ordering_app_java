...
import com.tss.model.menu.MenuIdGenerator;
...
public class AdminService {
	...
	private static boolean adminLogin(Scanner scanner) {
		...
		return username.equals(AdminDetails.getUsername()) && password.equals(AdminDetails.getPassword());
	}
	...
	private static void manageMenu(Scanner scanner) {
		...
		while (true) {
			...
			switch (option) {
			case 1 -> {
				int id = MenuIdGenerator.getNextId();
