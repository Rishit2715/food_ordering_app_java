...
public class AdminService {
	...
	public static void handleAdmin(Scanner scanner) {
		...
		OrderFacade orderFacade = new OrderFacade(); // ✅ FIX: Add this line
		...
		while (true) {
			...
			switch (adminChoice) {
				...
				case 2 -> DiscountService.manageDiscounts(orderFacade, scanner); // ✅ Uses the shared facade
				case 3 -> System.out.println("📌 Manage Delivery Partners feature coming soon!");
				case 4 -> {
